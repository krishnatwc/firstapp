<div class="page search-hotelspage" data-page="search-activity">
        <div class="navbar">
            <div class="navbar-inner">
                <div class="left"><a href="#index" class="link back with-animation"><i class="material-icons">arrow_back</i> 
					<span class="BoxPageNavbarTitle">Activity Search </span></a></div>
                <!--<div class="right"> 
       ...
       <form class="BoxPageForm" name="searchActivity_frm" id="searchActivity_frm">   
		<div class="content-block paddingNOne">
		     <input type="hidden" name="regionid" id="regionid" value="804" />
			 <input type="hidden" name="destination" id="destination" value="New Delhi" />
				<div class="HotelDiVBox">
					...
					<div class="HotelDiVBoxRight">
						...
						<p class="item-after PseitelDes"  id="selectedDest">New Delhi</p>
						</a>
					</div>
				</div>
				<div class="HotelDiVBox">
			 ...
			 <div class="btnHotelrel"><a href="#" class="findActivityResults with-animation">SEARCH ACTIVITY</a></div>
